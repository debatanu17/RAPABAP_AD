...
define view entity ZI_BOOKING_AD18_M
  as select from zbooking_ad18_m
  association        to parent ZI_TRAVEL_AD18_M  as _Travel         on  $projection.TravelId = _Travel.TravelId
  composition [0..*] of ZI_BOOKSUPPL_AD18_M      as _Bookingsuppl
